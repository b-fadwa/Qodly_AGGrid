...
export default {
    craft: {
        ...
        related: {
            settings: Settings(FullAgGridSettings, BasicSettings),
        },
    },
    info: {
        settings: FullAgGridSettings,
        sanityCheck: {
            keys: [
...
} as T4DComponentConfig<IFullAgGridProps>;

export interface IFullAgGridProps extends webforms.ComponentProps {
    state?: string;
